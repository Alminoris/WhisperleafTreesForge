...
public class ModBoatEntity extends Boat
{
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case POPLAR -> ModBlockSetsHelper.WOODEN_BOATS.get("poplar").get();
            case ALDER -> ModBlockSetsHelper.WOODEN_BOATS.get("alder").get();
            case ASPEN -> ModBlockSetsHelper.WOODEN_BOATS.get("aspen").get();
            default -> ModBlockSetsHelper.WOODEN_BOATS.get("willow").get();
        };
    }
    ...
    {
        WILLOW(ModBlockSetsHelper.WOODEN_PLANKS.get("willow").get(), "willow"),
        POPLAR(ModBlockSetsHelper.WOODEN_PLANKS.get("poplar").get(), "poplar"),
        ALDER(ModBlockSetsHelper.WOODEN_PLANKS.get("alder").get(), "alder"),
        ASPEN(ModBlockSetsHelper.WOODEN_PLANKS.get("aspen").get(), "aspen");
